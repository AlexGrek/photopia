...
# These directories will be created inside the container. For persistent storage
# in production, you should mount Docker volumes to these paths.
RUN mkdir -p /app/backend/storage/users \
             /app/backend/storage/groups
